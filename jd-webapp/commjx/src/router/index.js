...
import vinsearch from "../components/insearch";
import shoptwo from "../components/shoptwo";
import login  from "../components/loginlu"
import opensee from "../components/opensee";
...
let router = new VueRouter({
    routes:[
        ...
        {path:"/insearch",component:vinsearch},
        {path:"/shoptwo",component:shoptwo},
        {path:"/login",component:login},
        {path:"/opensee",component:opensee},
